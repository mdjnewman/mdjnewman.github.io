...
{% include figure.html src="/public/images/2014/05/waterfall-model.png" alt="Waterfall model of system development" caption='Waterfall model of system development – avoid it! (you want the cycle above to take two weeks, not twelve months) (<a href="http://en.wikipedia.org/wiki/File:Waterfall_model.svg" title="File:Waterfall model.svg">source</a>)' %}
...
<style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://player.vimeo.com/video/80576311' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
...
<style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='http://www.youtube.com/embed/c_Ot1OEfk9I' frameborder='0' allowfullscreen></iframe></div>
...
{% include figure.html src="/public/images/2014/05/rhino-painting.jpg" alt="Rhinoceros painting" caption='Most problems are people problems - recognise that everyone has a different perspective (<a href="http://alligator-sunglasses.com/post/8929519267/poor-rhinoceros" title="Poor rhinoceros">source</a>)' %}
